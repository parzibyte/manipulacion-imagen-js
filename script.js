...
/*
JavaScript me va a devolver un ImageData que contiene la propiedad data. Esa
data es un Uint8ClampedArray plano, no bidimensional. Cada elemento dentro
del arreglo no es un pixel, es un nivel de color. Por ejemplo, si nuestra imagen solo fuera de un pixel, se
vería así:
[255,123,220,255]
Ya que es
[R,G,B,A]
...
Ya que sería:
[R,G,B,A,R,G,B,A]
Cada pixel ocupa 4 elementos dentro del arreglo
*/
const CANTIDAD_NIVELES_POR_PIXEL = 4;


const convertirIndiceDePixelACoordenadas = (indice, ancho) => {
    const pixel = indice / CANTIDAD_NIVELES_POR_PIXEL;
    const x = pixel % ancho;
